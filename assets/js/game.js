...
for (var i = 0; i < enemyNames.length; i++) {
  if (playerHealth> 0) {
    ...
    /// pick a new enemy to fight based on the indez of the enemyNames array
    var pickedEnemyName = enemyNames[i];

    // reset enemyHealth before starting new fight
    enemyHealth = 50;

    //use debugger to pause script form running and check whats going on at that moment in code.
    debugger;
